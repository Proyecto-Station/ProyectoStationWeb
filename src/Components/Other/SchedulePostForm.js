...
function SchedulePostForm({ openModal, onCloseModal, combo, handlePostModal, data, ...props}) {
  return (
    <>
      <Modal open={openModal} onClose={onCloseModal} >
        <Grid container direction='column' justifyContent='center' alignItems='center'>
          <Box component='form' noValidate autoComplete='off' onSubmit={props.onPostSchedule} sx={Style.modalSx} >
            <div>
